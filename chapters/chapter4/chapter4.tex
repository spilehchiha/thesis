...
\section{Related Work}
	...
	The smart contract source codes collected in GitHub repositories associated with the previously published literature typically do not directly reference smart contracts deployed on the blockchain through an Ethereum address;
	...
	First, they would have to to inspect any block on-chain and then
	look for all the transactions that involve an address associated with that specific contract.
