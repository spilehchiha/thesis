...
\section{Smart Contracts}
    ...
    \subsection{Vulnerabilities}
        ...
        \paragraph{Short Address}
            ...
            Unfortunately, the EVM does not check the validity of addresses, and thus the only way to prevent this attack is to check the length of a transaction's input at the level of the smart contract using \texttt{msg.data}.