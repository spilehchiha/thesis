...
\section{Introductory Remarks}
	\label{sec:intro}
	Ethereum blockchain handles financial assets and contracts worth millions of U.S. dollars.
	It is the most widely used blockchain platform with millions of smart contracts.
...
\subsection{Data Application}
	...
	\end{figure}
		...
		For instance, consider the Re-entrancy vulnerability. We know that Slither, Mythril, and Oyente support the detection of the re-entrancy vulnerability.
